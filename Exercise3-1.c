...
// void read_data(float data[], int data_count, float* min_meas_p, float* max_meas_p, int my_rank);
...
int main(int argc, char* argv[]) {
    ...
    if (my_rank == 0) {
        printf("Ingresa el numero de puntos de datos: ");
        fflush(stdout);
        scanf("%d", &data_count);
        printf("Ingresa la medida minima: ");
        fflush(stdout);
        scanf("%f", &min_meas);
        printf("Ingresa la medida maxima: ");
        fflush(stdout);
        scanf("%f", &max_meas);
        printf("Ingresa la cantidad de contenedores: ");
        fflush(stdout);
        scanf("%d", &bin_count);
